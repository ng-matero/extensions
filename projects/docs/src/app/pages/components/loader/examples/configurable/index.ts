import { AppComponent as LoaderConfigurableComponent } from './app.component';

const loaderConfigurableExampleConfig = {
  title: 'Configurable loader',
  component: LoaderConfigurableComponent,
  files: [
    {
...
export { LoaderConfigurableComponent, loaderConfigurableExampleConfig };
